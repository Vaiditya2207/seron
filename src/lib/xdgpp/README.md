...
This is in very early stage and is exclusively relied on by the Seron launcher. Breaking changes WILL occur without prior notice.
...
Otherwise, it is automatically compiled as part of the seron build process.
