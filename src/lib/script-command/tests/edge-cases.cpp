...
# @seron.schemaVersion 1
# @seron.title Test
# @seron.argument1 { "type": "text", "placeholder": "query", "percentEncoded": true }
)";
  auto result = script_command::ScriptCommand::parse(source);
  REQUIRE(result.has_value());
...
# @seron.schemaVersion 1
# @seron.title Test
# @seron.argument1 { "type": "text", "placeholder": "query", "percentEncoded": false }
)";
  auto result = script_command::ScriptCommand::parse(source);
  REQUIRE(result.has_value());
  REQUIRE(result->arguments.size() == 1);
...
# @seron.schemaVersion 1
# @seron.title Test
# @seron.argument1 { "type": "text", "placeholder": "query" }
)";
  auto result = script_command::ScriptCommand::parse(source);
  REQUIRE(result.has_value());
  REQUIRE(result->arguments.size() == 1);
...
# @seron.schemaVersion 1
# @seron.title Test
# @seron.argument1 { "type": "text", "placeholder": "query", "optional": true }
)";
  auto result = script_command::ScriptCommand::parse(source);
  REQUIRE(result.has_value());
  REQUIRE(result->arguments.size() == 1);
...
# @seron.schemaVersion 1
# @seron.title Test
# @seron.argument1 { "type": "text", "placeholder": "query", "optional": false }
)";
  auto result = script_command::ScriptCommand::parse(source);
  REQUIRE(result.has_value());
  REQUIRE(result->arguments.size() == 1);
...
# @seron.schemaVersion 1
# @seron.title Test
# @seron.argument1 { "type": "text", "placeholder": "first" }
# @seron.argument2 { "type": "password", "placeholder": "second" }
# @seron.argument3 { "type": "dropdown", "placeholder": "third", "data": { "title": "Option", "value": "val" } }
)";
  auto result = script_command::ScriptCommand::parse(source);
  REQUIRE(result.has_value());
...
TEST_CASE("Title with special characters") {
  const char *source = R"(#!/bin/bash
# @seron.schemaVersion 1
# @seron.title Test & Special <Characters> "Quotes"
)";
  auto result = script_command::ScriptCommand::parse(source);
  REQUIRE(result.has_value());
