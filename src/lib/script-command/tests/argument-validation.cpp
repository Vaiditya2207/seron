...
# @seron.title Test
# @seron.argument1 { "type": "unknown_type", "placeholder": "test" }
)";
...
# @seron.schemaVersion 1
# @seron.title Test
# @seron.argument1 { "type": "dropdown", "placeholder": "select" }
)";
  auto result = script_command::ScriptCommand::parse(source);
  REQUIRE(!result.has_value());
...
# @seron.schemaVersion 1
# @seron.title Test
# @seron.argument1 { "type": "dropdown", "placeholder": "select", "data": { "title": "Option", "value": "opt1" } }
)";
  auto result = script_command::ScriptCommand::parse(source);
  REQUIRE(result.has_value());
...
# @seron.schemaVersion 1
# @seron.title Test
# @seron.argument1 { "type": "text", "placeholder": "enter text" }
)";
  auto result = script_command::ScriptCommand::parse(source);
  REQUIRE(result.has_value());
  REQUIRE(result->arguments.size() == 1);
...
# @seron.schemaVersion 1
# @seron.title Test
# @seron.argument1 { "type": "password", "placeholder": "enter password" }
)";
  auto result = script_command::ScriptCommand::parse(source);
  REQUIRE(result.has_value());
  REQUIRE(result->arguments.size() == 1);
...
# @seron.schemaVersion 1
# @seron.title Test
# @seron.argument1 { "type": "text", "placeholder": "test" }
)";
  auto result = script_command::ScriptCommand::parse(source);
  REQUIRE(result.has_value());
  auto &arg = result->arguments.at(0);
...
# @seron.schemaVersion 1
# @seron.title Test
# @seron.argument1 { "type": "text", "placeholder": "test", "optional": true, "percentEncoded": true }
)";
  auto result = script_command::ScriptCommand::parse(source);
  REQUIRE(result.has_value());
  auto &arg = result->arguments.at(0);
...
# @seron.schemaVersion 1
# @seron.title Test
# @seron.argument1 { "type": "text", "placeholder": "test", "secure": true }
)";
  auto result = script_command::ScriptCommand::parse(source);
  REQUIRE(result.has_value());
  auto &arg = result->arguments.at(0);
...
# @seron.schemaVersion 1
# @seron.title Test
# @seron.argument1 { "type": "password", "placeholder": "test", "secure": false }
)";
  auto result = script_command::ScriptCommand::parse(source);
  REQUIRE(result.has_value());
  auto &arg = result->arguments.at(0);
