...
# Optional parameters:
# @seron.icon 🛩
# @seron.packageName Web Searches
# @seron.argument1 { "type": "text", "placeholder": "from city", "percentEncoded": true }
# @seron.argument2 { "type": "text", "placeholder": "to city", "optional": true, "percentEncoded": true }
