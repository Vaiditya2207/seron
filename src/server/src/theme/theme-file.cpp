...
ThemeFile ThemeFile::seronDark() {
  InitData data;
  data.id = "seron-dark";
  data.name = "Seron Dark";
  data.variant = ThemeVariant::Dark;
  data.description = "Default Seron dark palette";
  data.semantics = {
...
ThemeFile ThemeFile::seronLight() {
  InitData data;
  data.id = "seron-light";
  data.variant = ThemeVariant::Light;
  data.name = "Seron Light";
  data.description = "Default Seron light palette";
  data.semantics = {
