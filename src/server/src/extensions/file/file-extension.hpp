...
public:
  ...
  std::vector<Preference> preferences() const override {
    ...
    indexing.setDescription(
        "Whether to enable automatic file indexing in the background. If this is turned off, Seron will "
        "still be "
    ...
    paths.setDescription("Semicolon-separated list of paths that seron will search");
