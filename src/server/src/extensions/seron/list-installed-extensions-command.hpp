...
class SeronListInstalledExtensionsCommand : public BuiltinViewCommand<InstalledExtensionsViewHost> {
  ...
  QString description() const override {
    return "Show all third-party extensions that have been installed. This includes local extensions as well "
           "as extensions downloaded from the stores (seron and raycast).";
  }
