...
public:
  ...
  SeronStoreService *seronStore() const;
  ...
  void setSeronStore(std::unique_ptr<SeronStoreService> service);
...
private:
  ...
  std::unique_ptr<SeronStoreService> m_seronStoreService;
