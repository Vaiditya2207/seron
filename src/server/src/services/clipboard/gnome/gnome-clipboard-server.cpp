...
bool GnomeClipboardServer::isActivatable() const {
  ...
  // Test if the seron@dagimg-dot extension is available
  if (!testExtensionAvailability()) {
    qWarning() << "GnomeClipboardServer: seron@dagimg-dot extension not installed or not running";
    ...
    qWarning() << "GnomeClipboardServer: Extension available at: "
                  "https://github.com/dagimg-dot/seron-gnome-extension";
