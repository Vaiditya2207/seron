...
void SettingsWindow::ensureInitialized() {
  ...
  m_engine.addImageProvider(QStringLiteral("seron"), new AsyncImageProvider());
  ...
  m_engine.load(QUrl(QStringLiteral("qrc:/Seron/SettingsWindow.qml")));
...
QString SettingsWindow::version() const { return QStringLiteral(SERON_GIT_TAG); }
QString SettingsWindow::commitHash() const { return QStringLiteral(SERON_GIT_COMMIT_HASH); }
