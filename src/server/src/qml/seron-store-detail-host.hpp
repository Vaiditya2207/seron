...
class SeronStoreDetailHost : public FormViewBase {
  Q_OBJECT
...
public:
  ...
  SeronStoreDetailHost(const QString &authorHandle, const QString &extensionName);
...
private:
  ...
  void hydrate(const SeronStore::Extension &extension);

  SeronStore::Extension m_ext;
