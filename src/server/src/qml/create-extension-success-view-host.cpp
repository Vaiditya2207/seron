...
For commands from this extension to be picked up by Seron, you need to run your extension in development mode at least once:
...
You can learn more about extension development in the [Seron documentation](https://docs.seron.com/).
)";
...
QUrl CreateExtensionSuccessViewHost::qmlComponentUrl() const {
  return QUrl(QStringLiteral("qrc:/Seron/MarkdownDetailView.qml"));
}
