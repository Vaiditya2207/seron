        ...
        Item {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Image {
                        source: "image://seron/builtin:magnifying-glass?fg=" + Theme.textMuted
                        sourceSize.width: 12
                    ...
                    RowLayout {
                        ...
                        ViciImage {
                            visible: {
                                ...
                                return p === "Raycast" || p === "Seron" || p === 'Local';
                            }
                            source: {
                                const p = navItem.modelData.provenance ?? "";
                                if (p === "Raycast")
                                ...
                                if (p === "Seron")
                                    return Img.builtin("seron").withFillColor(Theme.toastWarning);
                                if (p === "Local")
