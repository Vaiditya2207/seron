...
Item {
    ...
    FormView {
        ...
        FormField {
            ...
            info: 'If you plan on submitting your extension to the <a href="seron://extensions/seron/seron/store">Seron store</a>, this must exactly match your GitHub handle. Otherwise, you can set it to anything.'
        ...
        FormField {
            ...
            FormTextInput {
                ...
                placeholder: "~/code/seron-extensions"
