...
Flickable {
    ...
    ColumnLayout {
        ...
        SettingsRow {
            label: "Icon Theme"
            description: "The icon theme used for system icons (applications, mime types, folder icons...). Does not affect builtin Seron icons."
            SearchableDropdown {
                width: parent.width
        ...
        SettingsRow {
            ...
            description: "Let Seron draw its own rounded borders instead of relying on the windowing system."
            SettingsToggle {
        ...
        SettingsRow {
            ...
            description: "Use platform/fontconfig text rendering for system-consistent text. Disable for Qt distance-field rendering (usually faster). May require reopening Seron to fully apply."
            SettingsToggle {
