...
from within Seron (`seron://extensions/seron/developer/create`)

To make developing templates easy, this repo itself is a valid Seron extension and you can run it in development mode like any other:
